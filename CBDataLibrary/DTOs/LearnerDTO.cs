...
namespace CBDataLibrary.DTOs
{
    public class LearnerDTO
    {
        ...
        public List<SiblingDetailDTO> SiblingDetails { get; set; }
        public List<DisabilityDetailDTO> DisabilityDetails { get; set; }
        public List<LanguageDetailDTO> LanguageDetails { get; set; }
        public List<SENProvisionDetailDTO> SENProvisionDetails { get; set; }
